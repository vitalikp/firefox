...
FRAME_ID(nsMathMLmoverFrame, None, NotLeaf) // XXX unused?
...
FRAME_ID(nsMathMLmstyleFrame, None, NotLeaf)  // XXX unused?
...
FRAME_ID(nsMathMLmunderFrame, None, NotLeaf)  // XXX unused?
