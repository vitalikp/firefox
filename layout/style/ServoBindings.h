...
nsAtom* Gecko_LocalName(RawGeckoElementBorrowed element);
nsAtom* Gecko_Namespace(RawGeckoElementBorrowed element);
nsAtom* Gecko_GetElementId(RawGeckoElementBorrowed element);
...
void Gecko_FontFamilyList_AppendNamed(FontFamilyList* aList, nsAtom* aName, bool aQuoted);
