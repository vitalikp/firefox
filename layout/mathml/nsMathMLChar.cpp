                              ...
                              bool aIsSelected)
{
  ...
  thebesContext->Save();
  nsRect r = mRect + aPt;
  ApplyTransforms(thebesContext, aForFrame->PresContext()->AppUnitsPerDevPixel(), r);
  ...
  switch(mDraw)
  {
    ...
    case DRAW_PARTS: {
      ...
      if (NS_STRETCH_DIRECTION_VERTICAL == mDirection)
        PaintVertically(presContext, thebesContext, r, fgColor);
      else if (NS_STRETCH_DIRECTION_HORIZONTAL == mDirection)
        PaintHorizontally(presContext, thebesContext, r, fgColor);
      break;
    }
    default:
