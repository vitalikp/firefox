...
nsInputStreamPump::OnInputStreamReady(nsIAsyncInputStream *stream)
{
    ...
    PROFILER_LABEL("nsInputStreamPump::OnInputStreamReady", NETWORK);
...
nsInputStreamPump::OnStateStart()
{
    ...
    PROFILER_LABEL("nsInputStreamPump::OnStateStart", NETWORK);
...
nsInputStreamPump::OnStateTransfer()
{
    ...
    PROFILER_LABEL("nsInputStreamPump::OnStateTransfer", NETWORK);
...
nsInputStreamPump::OnStateStop()
{
    ...
    PROFILER_LABEL("nsInputStreamPump::OnStateStop", NETWORK);
